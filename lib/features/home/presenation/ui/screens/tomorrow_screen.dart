            ...
            builder: (context, state) {
              if (state is SuccessWeatherState) {
                return WeatherInfoBody(
                  prograssTemp: state.weatherData[1].avgTempC,
                  prograssHumaditiy: state.weatherData[1].avgHumidity,
                  prograssWind: state.weatherData[1].maxWindKph,
                );
