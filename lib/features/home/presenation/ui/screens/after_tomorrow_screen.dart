...
class AfterTomorrowScreen extends StatelessWidget {
  const AfterTomorrowScreen({super.key});
            ...
            builder: (context, state) {
              if (state is SuccessWeatherState) {
                return WeatherInfoBody(
                  prograssTemp: state.weatherData[2].avgTempC,
                  prograssHumaditiy: state.weatherData[2].avgHumidity,
                  prograssWind: state.weatherData[2].maxWindKph,
                );
